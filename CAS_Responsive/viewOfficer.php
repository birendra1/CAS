...
<div id="main" >
  <button class="openbtn w3-green" onclick="openNav()">&#9776;  <span style="padding-left: 95px;padding-right:140px "> View Officer</span> </button> 
...
<!-- One officer take a maximum of 5 jobs at a time -->
	...
	<!-- This section shows all the details of officers -->
		...
		<table class="w3-padding-large  w3-margin-top w3-dark-gray w3-large w3-text-white w3-mobile" style="border-radius: 8px" id="pagecont">
			<tr>
				<td style="padding-left: 4px;width: 200px;font-weight: bold">Officer id: </td>
				<td><?php echo $row['id']; ?></td>
			</tr>

			<tr>
				<td style="padding-left: 4px;width: 200px;font-weight: bold">Officer Name: </td>
					<td><?php echo $row['name']; ?></td>
			</tr>

			<tr>
				<td style="padding-left: 4px;width: 200px;font-weight: bold">Mobile: </td>
				<td><?php echo $row['phone'] ;?></td>
			</tr>

			<tr>
				<td style="padding-left: 4px;width: 200px;font-weight: bold">EMail : </td>
				<td><?php echo $row['email'] ;?></td>
			</tr>
			
			<tr>
				<td style="padding-left: 4px;width: 200px;font-weight: bold">Address : </td>
				<td><?php echo $row['address'] ;?></td>
			</tr>

			<tr>
				<td style="padding-left: 4px;width: 200px;font-weight: bold">State: </td>
				<td><?php echo $row['state'] ;?></td>
			</tr>

			<tr>
				<td style="padding-left: 4px;width: 200px;font-weight: bold">District : </td>
		...
		<td><img src="<?php echo $row['photo'] ?>" alt="Photo not found" height="100px" width="170px"></td>
			...
			<button type="submit" name="edit" class="w3-button w3-blue w3-large w3-mobile w3-padding w3-margin-top" value="edit" >Edit</button>
		</form>
	</td>
	</tr>
