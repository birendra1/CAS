...
<div id="mySidebar" class="sidebar " >
  ...
  <a href="feedback.php" class="fas fa-comments" style="padding-left: 5%;width: 100%;"><span style="padding-left: 15.35%">Feedback</span></a>
...
<div id="main" >
  <button class="openbtn" onclick="openNav()">&#9776;  <span style="padding-left: 95px;padding-right:140px "> Add Officer</span> </button> 
