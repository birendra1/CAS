...
<div id="main" >
  <button class="openbtn" onclick="openNav()">&#9776;  <span style="padding-left: 45px;padding-right:140px "> Update Complaints</span> </button> 
    ...
    <!-- Php code goes here -->
        ...
        ?>
         ...
         <table class=" w3-mobile w3-round w3-padding w3-large w3-dark-gray"  > 
         ...
         <tr><td style="padding: 5px;width: 150px;;font-weight: bold">Complain id:</td><td style="padding: 5px">  <?php echo $row['complainid']; ?></td></tr>
          <tr><td style="padding: 5px;font-weight: bold"> Title :</td><td style="padding: 5px">  <?php echo $row['title']; ?></td></tr>
           <tr><td style="padding: 5px;font-weight: bold"> Subject : </td><td style="padding: 5px">  <?php echo $row['subject']; ?></td></tr>   
            ...
            <tr>
              <td style="padding: 5px;font-weight: bold">Status :</td><td>
          ...
          <tr><td></td><td>
              ...
              <button type="submit" class="w3-btn w3-blue w3-round w3-medium w3-margin-top w3-mobile" name="Update" value="Update" style="margin-bottom: 35px">Update</button></form></td>
