...
<body id="body">
  ...
  <h1 align="center">Reset Password User</h1>
</div>
<?php
...
<?php
  ...
  elseif (isset($_POST['sendOTP'])) {
    ...
    if (mysqli_num_rows(mysqli_query($conn,$findQuery)) == 0) {
      ...
      echo "<div style='margin-left:42.5%;margin-top:5%;font-size:25px'>Click to <a href='userLogin.php'><b>Login</b></a> </div>";
  ...
  elseif (isset($_POST['verifyOTP'])) {
    ...
    if ($otp == $cotp) {
      ...
      echo "<div style='margin-left:40%;font-size:25px;margin-top:2%;'>Incorrect OTP try again <a href='forgotPasswordUser.php'><b> Click Here </b></a></div>";
    }
  }
